...
def eye_aspect_ratio(eye):
	# computing the euclidean distances between the two sets of
...
# grabbing the indexes of the facial landmarks for the left and
...
while True:
	...
	# grabbing the frame from the threaded video file stream, resize
	...
	for rect in rects:
		...
		# extracting the left and right eye coordinates, then use the
