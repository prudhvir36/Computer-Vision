...
LABELMAP_NAME = 'labelmap.txt'   # Name of labelmap file inside model folder
resolution = [1280, 720]   # Desired camera resolution (width by height)
min_conf_threshold = 0.50   # Minimum confidence to display detected object

imW, imH = resolution[0], resolution[1]
