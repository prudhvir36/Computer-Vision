...
_defaults = _config.get('default_constants')['pt']['trn']['trn_utils_v7']
...
def train(opt: object) -> str:
    ...
    hyp['cls'] *= nc / _defaults['base_num_cls'] * 3. / nl  # scale to classes and layers
    # scale to image size and layers
    hyp['obj'] *= (imgsz / _defaults['base_img_size']) ** 2 * 3. / nl
